...
export const loginWithGoogle = createAsyncThunk(
  ...
  async (
    ...
    try {
      ...
      const { user, token, accountType } = res.data;
...
const authSlice = createSlice({
  ...
  reducers: {
    ...
    setAccountType: (state, action) => {
      ...
      AsyncStorage.setItem("accountType", action.payload || "");
    },
...
export const selectAccountType = (state: any) => state.auth.accountType;
export const selectIsLoggedIn = (state: any) => state.auth.isLoggedIn;
export const selectAuthLoading = (state: any) => state.auth.loading;
export const selectAuthError = (state: any) => state.auth.error;

export const selectIsAdmin = (state: any) =>
  state.auth.accountType === "admin";

export const selectIsNormalUser = (state: any) =>
  state.auth.accountType === "user";

export const selectIsBot = (state: any) =>
  ["bot", "assistant_bot", "support_bot", "system_bot"].includes(
    state.auth.accountType
  );

export const selectIsAssistantBot = (state: any) =>
  state.auth.accountType === "assistant_bot";

export const selectIsSupportBot = (state: any) =>
  state.auth.accountType === "support_bot";

export const selectIsSystemBot = (state: any) =>
  state.auth.accountType === "system_bot";

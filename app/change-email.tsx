...
//       setEmailError("هذا هو نفس البريد الحالي");
//       return;
//     }
...
//           type: "success",
//           text1: "تم بنجاح",
//           text2: "تم تغيير البريد الإلكتروني",
//         });
...
//           type: "error",
//           text1: "خطأ",
//           text2: resultAction.payload || "فشل تغيير البريد الإلكتروني",
//         });
//       }
//     } catch {
//       Toast.show({
...
//             <Text style={s.headerTitle}>تغيير البريد الإلكتروني</Text>

//             <View style={s.headerPlaceholder} />
//           </View>

//           <View style={s.card}>
//             <Text style={s.label}>البريد الحالي</Text>
//             <View style={s.currentEmailBox}>
//               <Text style={s.currentEmailText}>{me?.email || "غير متوفر"}</Text>
//             </View>

//             <Text style={[s.label, { marginTop: 18 }]}>البريد الجديد</Text>
//             <TextInput
//               value={email}
//               onChangeText={(text) => {
//                 setEmail(text);
...
//             <Text style={s.note}>
//               تأكد من إدخال بريد صحيح ويمكن الوصول إليه، لأنه قد يُستخدم لاحقًا في
//               استعادة الحساب أو التحقق.
//             </Text>
...
//               ) : (
//                 <Text style={s.buttonText}>حفظ البريد الجديد</Text>
//               )}
//             </TouchableOpacity>
//           </View>
//         </View>

...
const normalizeMessage = (msg: MessageItem): MessageItem => ({
  ...msg,
  type: (msg.type || "text") as MessageItem["type"],
  ...
  roomInvite: msg.roomInvite
    ? {
        roomId: String(msg.roomInvite.roomId || ""),
        roomName: msg.roomInvite.roomName || "",
        roomAvatar: msg.roomInvite.roomAvatar || "",
        roomType: msg.roomInvite.roomType || "",
        invitedBy: msg.roomInvite.invitedBy || "",
        invitedByName: msg.roomInvite.invitedByName || "",
        message: msg.roomInvite.message || "",
      }
    : undefined,
});
// const normalizeMessage = (msg: MessageItem): MessageItem => ({

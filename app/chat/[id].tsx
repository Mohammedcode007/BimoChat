...
export default function ChatScreen() {
  ...
  //     const existing = loadMessagesFromCache(currentUser._id, chatId);
  ...
  //   // 1) عرض الكاش فورًا
  //   const cached = loadMessagesFromCache(currentUser._id, chatId);
  //   if (cached.length) {
  ...
  //     .unwrap()
  //     .then((res) => {
  //       const merged = mergeMessages(cached, res.messages || []);

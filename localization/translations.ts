...
avatarGif: "GIF Avatar",
usernameColor: "Username Color",
messageTextColor: "Message Color",
        limited: "Limited",
      },
      badgePicker: {
...
settingsScreen: {
  ...
  rows: {
    ...
    messagesFriendsOnly: "Messages from friends only",
    darkMode: "Dark Mode",
  },
  ...
  edit: {
    ...
    statusPlaceholder: "Write your status message",
    emailTitle: "Email",
  ...
  media: {
    ...
    chooseImageWithCrop: "Choose Image with Crop",
  ...
  loading: {
    saving: "Saving...",
    uploadingImage: "Uploading image...",
    savingPrivacy: "Saving privacy setting...",
    savingOnlineStatus: "Saving online status...",
    savingSound: "Saving sound setting...",
    updatingAvatar: "Updating avatar...",
    updatingCover: "Updating cover...",
    changingPassword: "Changing password...",
    savingChanges: "Saving changes...",
    savingGender: "Saving gender...",
    savingCountry: "Saving country...",
    savingCity: "Saving city...",
    savingBirthdate: "Saving birthdate...",
  ...
  alerts: {
    ...
    gif: "GIF",
    chooseGifHint: "If you want to keep GIF animation, choose it from Choose GIF.",
    gifOnly: "GIF only",
    chooseGifOnly: "Please choose GIF image.",
  ...
  toasts: {
    ...
    selectCountryBeforeCity: "Please select your country before city",
    uploadFailed: "Upload failed",
    updateFailed: "Update failed",
    avatarUpdated: "Avatar updated",
    avatarGifUpdated: "Avatar GIF updated",
    coverUpdated: "Cover updated",
    failedUpdateGender: "Failed to update gender",
    failedUpdateCountry: "Failed to update country",
    failedUpdateCity: "Failed to update city",
    failedUpdateBirthdate: "Failed to update birthdate",
  },
},
    privacy: {
...
avatarGif: "أفاتار GIF",
usernameColor: "لون الاسم",
messageTextColor: "لون الرسالة",
        bundles: "الباقات",
        limited: "محدود",
      },
      badgePicker: {
...
messageTextColor: "لون الرسالة",
    ...
    settingsScreen: {
  notifications: "الإشعارات",
  notificationToggle: "تشغيل الإشعارات",
  ...
  rows: {
    ...
    messagesFriendsOnly: "الرسائل من الأصدقاء فقط",
    darkMode: "الوضع الداكن",
  },

  empty: {
    noStatus: "لا توجد رسالة حالة",
    noEmail: "لا يوجد بريد إلكتروني",
    notSet: "غير محدد",
    blockedCount: "{{count}} محظور",
    friendsOnly: "الأصدقاء فقط",
    everyoneCanMessage: "يمكن للجميع مراسلتك",
  },
  ...
  edit: {
    statusTitle: "رسالة الحالة",
    statusPlaceholder: "اكتب رسالة الحالة",
  ...
  media: {
    ...
    chooseImageWithCrop: "اختيار صورة مع قص",
    chooseGif: "اختيار GIF",
    changeCoverButton: "تغيير الغلاف",
  },

  loading: {
    saving: "جارٍ الحفظ...",
    uploadingImage: "جارٍ رفع الصورة...",
    savingPrivacy: "جارٍ حفظ إعداد الخصوصية...",
    savingOnlineStatus: "جارٍ حفظ حالة الاتصال...",
    savingSound: "جارٍ حفظ إعداد الصوت...",
    updatingAvatar: "جارٍ تحديث الصورة الشخصية...",
    updatingCover: "جارٍ تحديث الغلاف...",
    changingPassword: "جارٍ تغيير كلمة المرور...",
    savingChanges: "جارٍ حفظ التغييرات...",
    savingGender: "جارٍ حفظ النوع...",
    savingCountry: "جارٍ حفظ الدولة...",
    savingCity: "جارٍ حفظ المدينة...",
    savingBirthdate: "جارٍ حفظ تاريخ الميلاد...",
    removingBlock: "جارٍ إزالة الحظر...",
    loadingSettings: "جارٍ تحميل الإعدادات...",
  },

  alerts: {
    permissionRequired: "إذن مطلوب",
    allowPhotos: "يرجى السماح بالوصول إلى الصور.",
    gif: "GIF",
    chooseGifHint: "إذا كنت تريد الحفاظ على حركة GIF اخترها من خيار GIF.",
    gifOnly: "GIF فقط",
    chooseGifOnly: "يرجى اختيار صورة GIF.",
    unblockUser: "إلغاء حظر المستخدم",
    unblockConfirm: "هل أنت متأكد أنك تريد إلغاء حظر هذا المستخدم؟",
  },
  ...
  toasts: {
    ...
    failedUpdateSetting: "فشل تحديث الإعداد",
    currentPasswordRequired: "كلمة المرور الحالية مطلوبة",
    newPasswordMin: "كلمة المرور الجديدة يجب ألا تقل عن 6 أحرف",
    invalidEmail: "البريد الإلكتروني غير صحيح",
    updatedSuccessfully: "تم التحديث بنجاح",
    genderUpdated: "تم تحديث النوع",
    countryUpdated: "تم تحديث الدولة",
    cityUpdated: "تم تحديث المدينة",
    birthdateUpdated: "تم تحديث تاريخ الميلاد",
    userUnblocked: "تم إلغاء حظر المستخدم",
    failedToUnblock: "فشل إلغاء الحظر",
    chooseCountryFirst: "اختر الدولة أولًا",
    selectCountryBeforeCity: "يرجى اختيار الدولة قبل المدينة",
    uploadFailed: "فشل رفع الصورة",
    updateFailed: "فشل التحديث",
    avatarUpdated: "تم تحديث الصورة الشخصية",
    avatarGifUpdated: "تم تحديث الصورة المتحركة",
    coverUpdated: "تم تحديث الغلاف",
    failedUpdateGender: "فشل تحديث النوع",
    failedUpdateCountry: "فشل تحديث الدولة",
    failedUpdateCity: "فشل تحديث المدينة",
    failedUpdateBirthdate: "فشل تحديث تاريخ الميلاد",
  },
},
    tweetsScreen: {

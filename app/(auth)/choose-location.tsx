...
export default function ChooseLocationScreen() {
  ...
  const onContinue = async () => {
    ...
    if (!countryCode) {
      setError(t("chooseLocationScreen.errors.countryRequired"));
      return;
    }
    ...
    try {
      ...
      setError(
        typeof e === "string"
          ? e
          : t("chooseLocationScreen.errors.saveFailed")
      );
    } finally {
      setLoading(false);
    }
  ...
  const onSkip = async () => {
    ...
    if (!countryCode) {
      setError(t("chooseLocationScreen.errors.countryMinimum"));
      return;
    }
    ...
    try {
      ...
      setError(
        typeof e === "string"
          ? e
          : t("chooseLocationScreen.errors.continueFailed")
      );
    } finally {
      setLoading(false);
    }
      ...
      >
        ...
        >
          <View style={styles.card}>
            <Text style={styles.title}>{t("chooseLocationScreen.title")}</Text>
            <Text style={styles.subtitle}>
              {t("chooseLocationScreen.subtitle")}
            </Text>

            <Text style={styles.label}>{t("chooseLocationScreen.countryLabel")}</Text>
            <View style={styles.pickerWrap}>
              ...
              >
                <Picker.Item
                  label={t("chooseLocationScreen.selectCountry")}
                  value=""
                />
                {countries.map((item) => (
                  <Picker.Item
            ...
            <Text style={styles.label}>{t("chooseLocationScreen.cityLabel")}</Text>
            <View style={styles.pickerWrap}>
              <Picker
                selectedValue={city}
              ...
              >
                <Picker.Item
                  label={
                    countryCode
                      ? t("chooseLocationScreen.selectCity")
                      : t("chooseLocationScreen.selectCountryFirst")
                  }
                  value=""
                />
                {cities.map((item) => (
            ...
            >
              {loading ? (
                ...
                <Text style={styles.primaryBtnText}>
                  {t("chooseLocationScreen.saveAndContinue")}
                </Text>
              )}
            </Pressable>
            ...
            >
              <Text style={styles.secondaryBtnText}>
                {t("chooseLocationScreen.continueBtn")}
              </Text>
            </Pressable>
          </View>
        </ScrollView>

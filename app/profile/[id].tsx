...
function getCountryFlag(user?: Partial<ProfileUser> | null) {
  ...
  const fromName = String((user as any)?.country || "").trim().toLowerCase();
  if (fromName && countryNameToCode[fromName]) {
    const flag = codeToFlag(countryNameToCode[fromName]);
    if (flag) return flag;
  }
...
export default function ProfileScreen() {
  ...
  const displayFriends = toDisplay((user as any)?.friendsCount);
      ...
      <View style={{ flex: 1 }}>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 120 }}>
          ...
          <View style={styles.centerHeader}>
            ...
            <Text style={styles.profileIdText}>ID: {toDisplay(user._id)}</Text>
          </View>
          ...
          <View style={styles.profileStatsBox}>
            ...
            <View style={[styles.profileStatsRow, styles.profileStatsRowBottom]}>
              ...
              <StatItem label="@Username" value={toDisplay(user.atUsername)} />
            </View>
          </View>
